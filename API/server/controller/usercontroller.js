let BlazerUser = require('../model/usermodel');
...
exports.update = (req, res) => {
    ...
    BlazerUser.findByIdAndUpdate(id, req.body,{useFindAndModify: false})
    .then(data => {
        if(!data){
...
exports.delete = (req, res) => {
    ...
    const id = req.params.id
    BlazerUser.findByIdAndDelete(id)
    .then(data => {
        if(!data){
            res.status(404).send({message: "can not find user"})
        }else{
